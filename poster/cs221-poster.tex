...
\Large
\color{bluegray}
\emph{CS 221: Introduction to Aritificial Intelligence Class Project}
}
\end{textblock}
...
\begin{itemize}
  ...
  \item Given a set of electronic health records, we want to have a smart predictor that prompts high-risk patients to obtain diabetes testing
  
  \item Inspired by the Kaggle Practice Fusion Diabetes Classification challenge, with the important exception that we do not have full medical records

  \item Traditional approaches:
  \begin{itemize}
    \item Full medical record of patients and that patients all have a standard database
