...
\begin{itemize}
  ...
  \begin{addmargin}[1em]{2em}% 5em left, 2em right
    \begin{leftbar}
      \begin{tabbing}
  ...
  \item \textbf{Resulting structures} Produced 8 structures; avg 31 min with Julia implementation on an Intel Xeon E5-2650 processor (2.60 GHz), 32 GB RAM
...
\begin{itemize}
  ...
  \item \textbf{MLE with Laplace smoothing} We use MLE with Laplace smoothing to learn the conditional probabilities associated with each node
